            ...
            <div className="w-full max-w-none xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-4 xs:py-6 sm:py-8">
                ...
                {currentProject && (
                    <>
                        ...
                        <div className="bg-teal-50 border border-teal-200 rounded-lg p-3 xs:p-4 sm:p-6 mb-4 sm:mb-6 overflow-x-auto">
                            <h3 className="text-sm sm:text-base font-medium text-teal-800 mb-3 sm:mb-4">
